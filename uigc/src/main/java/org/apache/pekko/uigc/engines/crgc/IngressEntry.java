...
import org.apache.pekko.uigc.engines.crgc.jfr.IngressEntrySerialization;
...
public class IngressEntry implements Serializable {
    ...
    public void onMessage(ActorRef recipient, Iterable<RefInfo> refs) {
